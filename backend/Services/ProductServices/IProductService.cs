namespace backend.Services.ProductServices
{
    public interface IProductService
    {
        ...
        Task<ProductDetail> AddProductDetails(AddProductDetailModel productDetail, int productId, int storeId, int categoryId);
        Task<ProductDetail> GetProductDetails(int id);
        Task<Product> UpdateProduct(int id, ProductModel product);
        Task<ProductDetail> UpdateProductDetails(int id, AddProductDetailModel productDetail);
